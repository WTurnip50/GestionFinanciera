...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        if (name != string.Empty)
        {
            ...
            while (!salir)
            {
                ...
                var id = 0;
                var validar = int.TryParse(System.Console.ReadLine(), out id);
                if (validar)
                {
                    ...
                    switch (id)
                    {
                        ...
                        case 3:
                            if (ingresos.Count > 0)
                            {
                                ...
                                foreach (var ingreso in ingresos)
                                {
                                    ...
                                    {
                                        System.Console.WriteLine(
                                            $"Ingreso: {ingreso.Ingresos}, Concepto: {ingreso.Concepto}, Categoria: {ingreso.categoria}");
                                    }
                                }
                                ...
                                foreach (var retiro in ingresos)
                                {
                                    ...
                                    {
                                        System.Console.WriteLine(
                                            $"Retiro: {retiro.Retiros}, Concepto: {retiro.Concepto}, Categoria: {retiro.categoria}");
                                    }
                                }
                            }
                            else
                        ...
                        case 4:
                            ...
                            while (!access)
                            {
                                ...
                                int op = 0;
                                validar = int.TryParse(System.Console.ReadLine(), out op);
                                if (validar)
                                {
                                    switch (op)
                                    {
                                ...
                                {
                                    System.Console.WriteLine("Elige una opcion valida");
                                }
                            }
    ...
    public static int Categoria()
    {
        ...
        while (!flag)
        {
            ...
            i = 0;
            select = 0;
            var validar = int.TryParse(System.Console.ReadLine(), out select);
            if (validar)
            {
                if (select <= 10)
                {
                ...
                {
                    System.Console.WriteLine("Seleccione una categoria valida.");
                    System.Console.WriteLine("============================");
                }
            }
            else
            {
                System.Console.WriteLine("Introduzca un numero valido.");
                System.Console.WriteLine("============================");
            }
        }
